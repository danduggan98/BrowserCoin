...
def test_blockchain():
    ...
    t_00 = Transaction(500, node.masternode_pk, Me_public, None, None).sign(node.masternode_sk)
    t_01 = Transaction(1500, node.masternode_pk, You_public, None, None).sign(node.masternode_sk)
    t_02 = Transaction(200, node.masternode_pk, Alice_public, None, None).sign(node.masternode_sk)
    t_03 = Transaction(600, node.masternode_pk, Bob_public, None, None).sign(node.masternode_sk)
